...
echo "{\"TemplateId\":1,\"DomainName\": \"test.play.com\",\"AppName\": \"live\",\"StreamName\":\"livetest\",\"RecordStreams\": [{\"SourceURL\": \"rtp://127.0.0.1:5004\"},{\"SourceURL\": \"rtp://127.0.0.1:5006\"}],\"StorePath\" :\"/tmp/record\",\"EndTime\": $((current_timestamp + 6000)), \"Mp4FileDuration\": 120}" > /tmp/record_task.json
