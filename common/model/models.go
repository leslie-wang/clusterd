...
type BackupStreamDetailData struct {
	...
	// 推流唯一标识。
	// 注意：此字段可能返回 null，表示取不到有效值。
	UpstreamSequence *string `json:"UpstreamSequence,omitempty" name:"UpstreamSequence"`
	...
	// 当前流为备流: 0。
	// 注意：此字段可能返回 null，表示取不到有效值。
	MasterFlag *int64 `json:"MasterFlag,omitempty" name:"MasterFlag"`
}
...
type BackupStreamGroupInfo struct {
	...
	// 主备流信息。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BackupList []*BackupStreamDetailData `json:"BackupList,omitempty" name:"BackupList"`

	// 是否对该流开启了择优调度。
	// 0 - 未开启。
	// 1 - 已开启。
	// 注意：此字段可能返回 null，表示取不到有效值。
	OptimalEnable *int64 `json:"OptimalEnable,omitempty" name:"OptimalEnable"`

	// 域名分组的分组名称。
	// 注意：此字段可能返回 null，表示取不到有效值。
	HostGroupName *string `json:"HostGroupName,omitempty" name:"HostGroupName"`
}
...
type CreateLivePullStreamTaskRequestParams struct {
	...
	SpecifyTaskId *string `json:"SpecifyTaskId,omitempty" name:"SpecifyTaskId"`
...
type DescribeBackupStreamListResponseParams struct {
	// 主备流分组信息列表。
	// 注意：此字段可能返回 null，表示取不到有效值。
	StreamInfoList []*BackupStreamGroupInfo `json:"StreamInfoList,omitempty" name:"StreamInfoList"`
...
type DescribeDeliverLogDownListResponseParams struct {
	// 日志信息列表。
	LogInfoList []*PushLogInfo `json:"LogInfoList,omitempty" name:"LogInfoList"`
...
type EnableOptimalSwitchingRequestParams struct {
	...
	// 0 - 禁用。
	// 1 - 启用。
	EnableSwitch *int64 `json:"EnableSwitch,omitempty" name:"EnableSwitch"`
...
type PullStreamTaskInfo struct {
	...
	// 新增的推流地址。用于单任务推两路场景。
	// 注意：此字段可能返回 null，表示取不到有效值。
	BackupToUrl *string `json:"BackupToUrl,omitempty" name:"BackupToUrl"`
}
...
type SwitchBackupStreamRequestParams struct {
	// 推流域名。
	PushDomainName *string `json:"PushDomainName,omitempty" name:"PushDomainName"`
